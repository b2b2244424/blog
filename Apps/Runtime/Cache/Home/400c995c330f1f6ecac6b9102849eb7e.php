...
<!--main content-->
<div class="container" ng-app="IndexApp" ng-controller="IndexCrtl">
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
            ...
            <div class="left-content clearfix">
                <div class="article-title col-md-12 col-xs-12">
                    ...
                    <div class="index-article-title"><a href="article-{{article.aid}}">{{article.title}}</a></div>
                </div>
                ...
                <div class="article-desc">
                    ...
                    <ul>
                        <li data-toggle="tooltip" data-placement="right" title="发布日期"><i
                                class="glyphicon glyphicon-time"></i><span class="ctime">{{article.create_time}}</span>
                        </li>
                        <li data-toggle="tooltip" data-placement="right" title="标签"><i
                                class="glyphicon glyphicon-tag"></i><span class="cname">{{article.cname.cname}}</span>
                        </li>
                        <li data-toggle="tooltip" data-placement="right" title="浏览"><i
                                class="glyphicon glyphicon-eye-open"></i><span class="rnum">{{article.rnum}}</span>
                        </li>
                    </ul>
                    </div>
