...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            <form action="<?php echo U('Message/doReply');?>" method="post">
                ...
                <div class="row wrapper">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-lg-11">
                                <textarea name="content" readonly class="form-control parsley-validated" rows="6" data-minwords="6" data-required="true" style="margin: 0px -0.5px 0px 0px; height: 100px; width: 100%;"><?php echo ($message["content"]); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row wrapper">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-lg-11">
                                <textarea name="reply" class="form-control parsley-validated" rows="6" data-minwords="6" data-required="true" placeholder="回复内容..." style="margin: 0px -0.5px 0px 0px;height: 100px; width: 100%;"><?php echo ($message["reply"]); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row wrapper">
