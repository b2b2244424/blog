...
<script type="text/javascript" src="/Blog/Public/admin/users/black.js"></script>
        <section id="content" ng-app="blackApp" ng-controller="blackCrtl">
          <section class="vbox">
              ...
              <section class="panel panel-default">
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                      <tr ng-repeat="black in filtered = (blacks | filter:search) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                        <td><label class="checkbox m-n i-checks"><input type="checkbox" name="post[]"><i></i></label></td>
                        <td><a href="#">{{black.username}}</a></td>
                        <td>{{black.login_name}}</td>
                        <td>{{black.last_login}}</td>
                        <td>{{black.ip}}</td>
                        <td>
                          <a ng-click="white(black)" class="active" data-toggle="class"><i class="btn btn-default btn-success btn-sm">移出黑名单</i></a>
                        </td>
                        <td>
                          <a ng-click="delete(black)" class="active" data-toggle="class"><i class="btn btn-default btn-danger btn-sm">删除</i></a>
                        </td>
                        <td>
                      </tr>
                    </tbody>
