                  ...
                  <div class="row wrapper">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-11">
                        ...
                        <textarea id="editor" class="form-control parsley-validated" data-required="true" name="content" ng-model="articleData.content" style="overflow:scroll;height:250px;max-height:250px"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row wrapper">
