          ...
          <section class="vbox">
            <section class="scrollable padder">
              ...
              <section class="panel panel-default">
                <form data-validate="parsley" class="bs-example form-horizontal" ng-submit="submitArticle()" ng-controller="articleController">
                  <div class="row wrapper">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="col-lg-2 control-label">标题</label>
                        <div class="col-lg-10">
                          <input type="text" name="atitle" ng-model="articleData.atitle" class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                  ...
                  <div class="row wrapper">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-11">
                        ...
                        <textarea id="editor" class="form-control parsley-validated" data-required="true" name="contents" ng-model="articleData.contents" style="overflow:scroll;height:250px;max-height:250px"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row wrapper">
