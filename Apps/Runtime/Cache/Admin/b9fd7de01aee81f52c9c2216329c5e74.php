              ...
              <section class="panel panel-default">
                <div class="row wrapper">
                  <div class="col-sm-5 m-b-xs">
                    ...
                    <button class="btn btn-sm btn-default">操作</button>                
                  </div>
                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>2015-12-12</td>
                        <td>
                          <a href="#" class="active" data-toggle="class"><i class="btn btn-default btn-success btn-sm">编辑</i>
                        </td>
                        <td>
                          <a href="#" class="active" data-toggle="class"><i class="btn btn-default btn-danger btn-sm">删除</i>
                        </td>
                      </tr>
                      <tr>
                        <td><label class="checkbox m-n i-checks"><input type="checkbox" name="post[]"><i></i></label></td>
