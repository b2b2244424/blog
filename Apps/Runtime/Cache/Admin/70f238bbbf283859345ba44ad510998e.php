...
<script type="text/javascript" src="/Blog/Public/admin/message/app.js"></script>
                    ...
                    <tbody>
                      <tr ng-repeat="message in filtered = (messages | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                        ...
                        <td ng-show="message.rid <= 0">
                          <a href="<?php echo U('Admin/Message/reply');?>?mid={{message.mid}}"><i class="btn btn-default btn-success btn-sm">回复</i></a>
                        </td>
                        <td ng-show="message.rid > 0">
                          <a href="<?php echo U('Admin/Message/reply');?>?mid={{message.mid}}"><i class="btn btn-primary btn-sm">查看</i></a>
                        </td>
                        <td>
