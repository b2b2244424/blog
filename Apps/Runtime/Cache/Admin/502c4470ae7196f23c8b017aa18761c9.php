...
<link href="/Blog/Public/cropper/cropper.min.css" rel="stylesheet">
<link href="/Blog/Public/sitelogo/sitelogo.css" rel="stylesheet">
<script src="/Blog/Public/cropper/cropper.min.js"></script>
<script src="/Blog/Public/sitelogo/sitelogo.js"></script>
        <section id="content">
          <section class="vbox">
            <section class="scrollable">
              <section class="hbox stretch">
                <aside class="aside-lg bg-light lter b-r">
                  <section class="vbox">
                  <form action="<?php echo U('Admin/Users/updateone');?>" method="post">
                    <section class="scrollable">
                      <div class="wrapper">
                        <div class="text-center m-b m-t" id="crop-avatar">
                          <a href="javascript:;" class="thumb-lg avatar-view" title="更换头像">
                            <img src="/Blog/Public/admin/images/a0.png" class="img-circle">
                          </a>
                          <div>
                            <div class="h3 m-t-xs m-b-xs"><?php echo ($userinfo["username"]); ?></div>
                            <small class="text-muted"><i class="icon-symbol-male"></i>&nbsp;&nbsp;<?php echo ($userinfo["rolename"]); ?></small>
                          </div>
                        </div>
                        ...
                        <div class="panel wrapper">
                          <div class="row text-center">
                              <div class="form-group">
                                ...
                                <label class="col-lg-1 control-label">登录名</label>
                                <div class="col-lg-3">
                                  <input type="text" class="form-control m-b" name="login_name" value="<?php echo ($userinfo["login_name"]); ?>" readonly>
                                </div>
                                <div class="col-lg-4"></div>
                              </div>
                          </div>
                          <div class="row text-center">
                              <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                  <input type="text" class="form-control m-b" name="username" value="<?php echo ($userinfo["username"]); ?>">
                                </div>
                                <div class="col-lg-4"></div>
                              </div>
                          </div>
                          <div class="row text-center">
                              <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                  <input type="email" class="form-control m-b" name="email" value="<?php echo ($userinfo["email"]); ?>" readonly>
                                </div>
                                <div class="col-lg-4"></div>
                              </div>
                          </div>
                          ...
                          <div class="row text-center">
                              <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                  <input type="text" class="form-control m-b" name="domain" value="<?php echo ($userinfo["domain"]); ?>">
                                </div>
                                <div class="col-lg-4"></div>
                              </div>
                          </div>
                          <div class="row text-center">
                              <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                  ...
                                  <a href="<?php echo U('Admin/Users/index');?>" class="btn btn-default pull-right">取消</a>
                                </div>
                                <div class="col-lg-4"></div>
                              </div>
                          </div>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form class="avatar-form" action="<?php echo U('Admin/Users/updateHead');?>" enctype="multipart/form-data" method="post">
